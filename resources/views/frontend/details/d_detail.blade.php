        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <h2 class="m-0">Overview of Unit Flat (D)</h2>
    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" style="margin-left:5%">
        ...
        <div class="carousel-inner" style="width:1100px; height:700px" >
            ...
            <div class="carousel-item">
                <img src="{{ asset('image/space/12.jpg') }}" class="d-block w-100" alt="Slide 2">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('image/space/14.jpg') }}" class="d-block w-100" alt="Slide 3">
            </div>
        </div>
       ...
       <div class="row">
        ...
        <div class="col-md-4">
            <ul>
                ...
                <li> <strong>FlatSize:</strong>   <span> 1400(sq.ft)</span></li>
                <li> <strong>Location :</strong>   <span>7/A Dhanmondi, Road-3,Dhaka-1209</span></li>
                <li> <strong>Total Floor :</strong>   <span>24</span></li>
                <li> <strong>Total C Unit:</strong>   <span>06 (1D,2D,3D,4D,5D,6D)</span></li>
                <li> <strong>Flat For :</strong>   <span>Rent</span></li>
                <li> <strong>Bedrooms :</strong>   <span> 03</span></li>
                <li> <strong>Washroom :</strong>   <span> 03</span></li>
        ...
        <div class="col-md-4">
            <ul>
                ...
                <li> <strong>Balcony:</strong>   <span> 03</span></li>
                <li> <strong>Floor Avaiable On:</strong>   <span> 1th Floor, 5th Floor</span></li>
                ...
                <li> <strong>Rent Cost</strong>   <span> 18000 tk</span></li>
                ...
                <div class="col-md-8">
                    ...
                    <h6>House Name:&nbsp;  Root & Hawari <br>
                     Address:&nbsp;  7/A Dhanmondi-Dhaka 1209 Storied Building (G+9) 4 Unit. <br>
                      ...
                      Flat (D): &nbsp;3 Bedroom, 3 Bath, 3 varanda, Drawing, Dining and kitchen etc. <br>Lift, Generator ,Intercom Car Parking: Ground Floor Community Space</h6>
                </div>
            </div>
        </div>
        <div class="card-body" >
