        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <h2 class="m-0">Overview of Unit Flat (C)</h2>
    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" style="margin-left:5%">
        ...
        <div class="carousel-inner" style="width:1100px; height:700px" >
            <div class="carousel-item active">
                <img src="{{ asset('image/space/16.jpg') }}" class="d-block w-100" alt="Slide 1">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('image/space/14.jpg') }}" class="d-block w-100" alt="Slide 2">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('image/space/13.jpg') }}" class="d-block w-100" alt="Slide 3">
            </div>
        </div>
       ...
       <div class="row">
        ...
        <div class="col-md-4">
            <ul>
                ...
                <li> <strong>Balcony:</strong>   <span> 02</span></li>
                <li> <strong>Floor Avaiable On:</strong>   <span> 4th Floor, 6th Floor</span></li>
                ...
                <li> <strong>Rent Cost</strong>   <span> 15000 tk</span></li>
                ...
                <div class="col-md-8">
                    ...
                    <h6>House Name:&nbsp;  Root & Hawari <br>
                     Address:&nbsp;  7/A Dhanmondi-Dhaka 1209 Storied Building (G+9) 4 Unit. <br>
                      ...
                      Flat (C): &nbsp;3 Bedroom, 2 Bath, 2 varanda, Drawing, Dining and kitchen etc. <br>Lift, Generator ,Intercom Car Parking: Ground Floor Community Space</h6>
                </div>
            </div>
        </div>
        <div class="card-body" >
