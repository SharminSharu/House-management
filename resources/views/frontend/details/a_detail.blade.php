        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <h2 class="m-0">Overview of Unit Flat (A)</h2>
    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" style="margin-left:5%">
        ...
        <div class="carousel-inner" style="width:1100px; height:700px" >
            ...
            <div class="carousel-item">
                <img src="{{ asset('image/space/15.jpg') }}" class="d-block w-100" alt="Slide 2">
            </div>
            <div class="carousel-item">
       ...
       <div class="row">
        ...
        <div class="col-md-4">
            <ul>
                ...
                <li> <strong>Floor Avaiable On:</strong>   <span> 2nd Floor, 5th Floor</span></li>
                ...
                <li> <strong>Rent Cost</strong>   <span> 9000 tk</span></li>
                ...
                <div class="col-md-8">
                    ...
                    <h6>House Name:&nbsp;  Root & Hawari <br>
                     Address:&nbsp;  7/A Dhanmondi-Dhaka 1209 Storied Building (G+9) 4 Unit. <br>
                      ...
                      Flat (A): &nbsp;2 Bed, 1 Bath, 1 varanda,Drawing, Dining and kitchen etc. <br>Lift, Generator ,Intercom Car Parking: Ground Floor Community Space</h6>
                </div>
            </div>
        </div>
        <div class="card-body" >
